...
docker compose exec -T -u glue_user -w /home/glue_user/workspace/jupyter_workspace glue.dev /home/glue_user/spark/bin/spark-submit src/glue_app/handlers/sample.py --REGION=ap-northeast-1 --JOB_NAME=sampleEtlJob
